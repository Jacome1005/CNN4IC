module user_project_example (clk_i,
 ...
 sg13g2_tiehi _203_ (.VDD(VPWR),
    .VSS(VGND),
    .L_HI(uo_CORE2PAD[1]));
 sg13g2_tielo _204_ (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(uo_CORE2PAD[2]));
 sg13g2_tielo _205_ (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(uo_CORE2PAD[3]));
 sg13g2_tielo _206_ (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(uo_CORE2PAD[4]));
 sg13g2_tielo _207_ (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(uo_CORE2PAD[5]));
 sg13g2_tielo _208_ (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(uo_CORE2PAD[6]));
 sg13g2_tielo _209_ (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(uo_CORE2PAD[7]));
 sg13g2_tielo _210_ (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(uo_CORE2PAD[8]));
 sg13g2_tielo _211_ (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(uo_CORE2PAD[9]));
 sg13g2_tielo _212_ (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(uo_CORE2PAD[10]));
 sg13g2_tielo _213_ (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(uo_CORE2PAD[11]));
 sg13g2_tielo _214_ (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(uo_CORE2PAD[12]));
 sg13g2_tielo _215_ (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(uo_CORE2PAD[13]));
 sg13g2_tielo _216_ (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(uo_CORE2PAD[14]));
 sg13g2_tielo _217_ (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(uo_CORE2PAD[15]));
 sg13g2_tielo _218_ (.VDD(VPWR),
    .VSS(VGND),
    .L_LO(uo_CORE2PAD[16]));
