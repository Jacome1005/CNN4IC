//=======================================================
//  CNNver3 — Top Level (arquitectura reorganizada)
//=======================================================
//  Puertos externos (8):
...
module CNNver3 (
    output wire CNNver3_MISO,
    input  wire CNNver3_SPICLOCK_50,
    input  wire CNNver3_SS_N,
    input  wire CNNver3_MOSI,
    input  wire CNNver3_Reset_InHigh,
    input  wire CNNver3_CMD_Reset,
    output wire CNNver3_MR1_Load,     // DEBUG: activo bajo, pulso al cargar MR1
    output wire CNNver3_MR2_Load      // DEBUG: activo bajo, pulso al cargar MR2
);
    ...
    comm_mem_top #(
        ...
        // Debug
        .o_MR1_Load_dbg(CNNver3_MR1_Load),
        .o_MR2_Load_dbg(CNNver3_MR2_Load),
        // Imagen hacia proc
